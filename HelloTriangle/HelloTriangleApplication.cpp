...
bool HelloTriangleApplication::Load()
{
  ...
  _vertexShader = CreateVertexShader(L"../dx11helloworld/shaders/hellotriangle.hlsl", vertexShaderBlob);
  if (_vertexShader == nullptr)
  {
    return false;
  }

  _pixelShader = CreatePixelShader(L"../dx11helloworld/shaders/hellotriangle.hlsl");
